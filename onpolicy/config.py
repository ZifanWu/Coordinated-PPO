...
def get_config():
    ...
    parser.add_argument('--if_use_CoPPO', type=bool, default=True, help='by default True, otherwise MAPPO.')
    parser.add_argument('--if_use_independent_ppo', type=bool, default=None)
    ...
    parser.add_argument('--if_detach_others', action='store_true', default=False)
    ...
    parser.add_argument('--prcl_max_clip_param', type=float, default=0.30)
    parser.add_argument('--prcl_curr_clip_param', default=0.20)
    parser.add_argument('--prcl_min_clip_param', type=float, default=0.10)

    parser.add_argument('--clip_before_prod', type=bool, default=True)
    ...
    parser.add_argument("--user_name", type=str, default='',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--gain", type=float, default=0.01,
                        help="The gain # of last action layer") # the bigger the gain,模型初始化方差越大
