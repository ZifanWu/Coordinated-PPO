...
class CoPPO_SharedReplayBuffer(object):
    """
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        share_obs_shape = cent_obs_space[:1]
        ...
        self.state = np.zeros((self.episode_length + 1, self.n_rollout_threads, num_agents, args.state_shape), dtype=np.float32)
    ...
    def insert(self, share_obs, obs, rnn_states_actor, rnn_states_critic, actions, action_log_probs, value_preds, 
               rewards, masks, state, bad_masks=None, active_masks=None, available_actions=None, pi_dist=None, trgt_values=None, trgt_rnn_states_critic=None):
        """
        ...
        :param state: np, for Amix.b
        :param pi_dist: np(n_r_t, n_ags, n_acts) for kl regularization.
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        for indices in sampler:
            ...
            share_obs_batch = np.stack(share_obs_batch, axis=1) # (chunk_len, 120, o_dim)
            ...
            yield share_obs_batch, obs_batch, rnn_states_batch, rnn_states_critic_batch, actions_batch,\
                value_preds_batch, return_batch, masks_batch, active_masks_batch, old_action_log_probs_batch,\
                adv_targ, available_actions_batch, state_batch


class MAPPO_SharedReplayBuffer(object):
    """
    Buffer to store training data.
    :param args: (argparse.Namespace) arguments containing relevant model, policy, and env information.
    :param num_agents: (int) number of agents in the env.
